...
Features:
    ...
    Admin Dashboard – Add, Edit, Delete post
    Management Reports.
    Secure coding, user authentication.
    Image uploads capabilities
    Notifications
    Live updates on user activity.
    Live updates on admin activity.
